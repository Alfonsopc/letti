...
namespace Letti.Data.Migrations
{
    ...
    [Migration("20210326171541_organization_type_to_string")]
    partial class organization_type_to_string
    {
            ...
            modelBuilder.Entity("Letti.Model.PersonCompanyRelationship", b =>
                {
                    ...
                    b.HasOne("Letti.Model.ContractorRelationshipType", "OrganizationRelationshipType")
                        .WithMany()
