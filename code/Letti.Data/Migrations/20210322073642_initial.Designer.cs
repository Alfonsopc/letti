...
namespace Letti.Data.Migrations
{
    ...
    [Migration("20210322073642_initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Letti.Model.Company", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Letti.Model.CompanyRelationshipType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Letti.Model.PersonCompanyRelationship", b =>
                {
                    b.HasOne("Letti.Model.Company", "Company")
                        .WithMany()
                        .HasForeignKey("CompanyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Letti.Model.CompanyRelationshipType", "OrganizationRelationshipType")
                        .WithMany()
